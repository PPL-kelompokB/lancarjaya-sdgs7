...
<body class="bg-gray-50 py-10">
    ...
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-md">
        ...
        <p class="text-gray-600 mb-6">Mendaftar untuk: <span class="font-semibold">{{ $volunteer->title }}</span></p>

        <form action="{{ route('volunteer.register.submit', $volunteer->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
