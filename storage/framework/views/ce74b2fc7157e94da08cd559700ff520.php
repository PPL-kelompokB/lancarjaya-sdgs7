        ...
        <main class="flex-1 p-4 sm:p-6 lg:p-10">
            ...
            <header class="mb-8 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div class="flex items-center gap-8">
                    ...
                    <form method="GET" action="<?php echo e(route('admin.organizations.index')); ?>" class="relative">
            ...
            <div class="space-y-10">
                <div class="flex flex-col items-end justify-between gap-6 md:flex-row">
                    ...
                    <div class="grid grid-cols-2 gap-3 md:grid-cols-4">
                        <div class="rounded-2xl bg-surfaceContainerHigh px-5 py-4 text-center">
                            <div class="text-2xl font-black text-primary"><?php echo e($totalOrganizations); ?></div>
                        ...
                        <div class="rounded-2xl bg-yellow-50 px-5 py-4 text-center">
                            <div class="text-2xl font-black text-yellow-700"><?php echo e($pendingCount); ?></div>
                        ...
                        <div class="rounded-2xl bg-green-50 px-5 py-4 text-center">
                            <div class="text-2xl font-black text-green-700"><?php echo e($verifiedCount); ?></div>
                        ...
                        <div class="rounded-2xl bg-red-50 px-5 py-4 text-center">
                            <div class="text-2xl font-black text-red-700"><?php echo e($rejectedCount); ?></div>
                ...
                <div class="overflow-hidden rounded-[28px] border border-outlineVariant/20 bg-white shadow-[0px_20px_40px_rgba(31,27,23,0.06)]">
                    <div class="flex flex-wrap items-center justify-between gap-4 border-b border-outlineVariant/10 bg-surfaceContainerLow/60 p-6">
                        <form method="GET" action="<?php echo e(route('admin.organizations.index')); ?>" class="flex flex-wrap items-center gap-4">
                            ...
                            <div class="relative">
                                <select name="type" class="appearance-none rounded-full border border-outlineVariant/30 bg-white py-2 pl-4 pr-10 text-sm font-semibold outline-none focus:border-transparent focus:ring-2 focus:ring-secondary">
                                    ...
                                    <?php $__currentLoopData = $organizationTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $organizationType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($organizationType); ?>" <?php echo e(request('type') == $organizationType ? 'selected' : ''); ?>>
                                            <?php echo e($organizationType); ?>
                                    ...
                                    <tr class="group transition-colors hover:bg-surfaceContainerLow">
                                        <td class="px-8 py-6">
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <p class="font-bold text-primary"><?php echo e($org->organization_name); ?></p>
                                                    <p class="text-xs text-textMuted"><?php echo e($org->pic_email ?? '-'); ?></p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-8 py-6">
                                            <span class="rounded-full bg-surfaceContainerHigh px-3 py-1 text-xs font-bold text-textMain">
                                                <?php echo e($org->organization_type ?? '-'); ?>

                                            </span>
                                        </td>

                                        <td class="px-8 py-6 text-sm text-textMuted">
                                            <?php echo e($org->pic_name ?? '-'); ?>

                                        </td>

                                        <td class="px-8 py-6 text-sm text-textMuted">
                                            <?php echo e(optional($org->created_at)->format('d M Y') ?? '-'); ?>
                                        ...
                                        <td class="px-8 py-6">
                                            ...
                                            <?php elseif($org->verification_status === 'rejected'): ?>
                    ...
                    <div class="flex items-center justify-between border-t border-outlineVariant/10 bg-surfaceContainerLow/20 px-8 py-6">
                        <span class="text-xs font-medium text-textMuted">
                            Showing <?php echo e($organizations->firstItem() ?? 0); ?> - <?php echo e($organizations->lastItem() ?? 0); ?> of <?php echo e($organizations->total()); ?> results
                        </span>
...
</html><?php /**PATH D:\programming files yk\eco-don\resources\views/admin/organizations.blade.php ENDPATH**/ ?>