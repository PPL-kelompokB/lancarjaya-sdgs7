...
<head>
    ...
    <title><?php echo e($user->name); ?> - Dashboard Pendonasi</title>
...
<body class="bg-surface font-body text-on-surface min-h-screen flex">
    ...
    <aside class="hidden md:flex flex-col h-screen w-64 bg-[#f6ece6] text-[#003527] py-8 space-y-2 sticky top-0 rounded-r-[2rem]">
        ...
        <nav class="flex-grow space-y-2">
            <a class="bg-gradient-to-r from-[#003527] to-[#064e3b] text-white rounded-full px-4 py-3 mx-4 flex items-center gap-3" href="<?php echo e(route('user.dashboard')); ?>">
            ...
            <a  href="<?php echo e(route('user.explore')); ?>"
             ...
             <a href="<?php echo e(route('user.blog.index')); ?>"
                class="text-stone-700 px-4 py-3 mx-4 flex items-center gap-3 hover:bg-emerald-100/50 rounded-full transition-all" href="#">
                            ...
                            <div class="relative w-28 h-28 sm:w-36 sm:h-36 rounded-2xl overflow-hidden border-4 sm:border-8 border-surface bg-white shadow-xl -mt-16 sm:-mt-24">
                                <?php if(!empty($user->profile_photo)): ?>
                                    <img
                                        ...
                                        src="<?php echo e(asset('storage/' . $user->profile_photo)); ?>"
                            ...
                            <section class="bg-surface-container rounded-2xl p-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div class="bg-white rounded-2xl border border-outline-variant/20 p-5">
                                        ...
                                        <p class="text-3xl font-black text-primary mt-2"><?php echo e($donations->count()); ?></p>
                                    ...
                                    <div class="bg-white rounded-2xl border border-outline-variant/20 p-5">
                                        ...
                                        <p class="text-3xl font-black text-primary mt-2"><?php echo e($donations->where('status', 'in_progress')->count()); ?></p>
                            ...
                            <section class="bg-surface-container rounded-2xl p-6">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="bg-white rounded-xl px-4 py-3">
                                        ...
                                        <p class="font-semibold break-all"><?php echo e($user->email ?: '-'); ?></p>
                                    </div>
                                    ...
                                    <div class="bg-white rounded-xl px-4 py-3">
                                        ...
                                        <p class="font-semibold"><?php echo e($user->address ?: '-'); ?></p>
                                    </div>
                                </div>
                            </section>
                        </div>
                        ...
                        <section class="bg-surface-container rounded-2xl p-6">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <div class="bg-white rounded-xl px-4 py-3"><?php echo e($user->name ?: '-'); ?></div>
                                </div>

                                <div>
                                    <p class="text-xs uppercase tracking-wider text-on-surface-variant font-semibold mb-1">Email</p>
                                    <div class="bg-white rounded-xl px-4 py-3 break-all"><?php echo e($user->email ?: '-'); ?></div>
                                </div>

                                <div>
                                    <p class="text-xs uppercase tracking-wider text-on-surface-variant font-semibold mb-1">Nomor Telepon</p>
                                    <div class="bg-white rounded-xl px-4 py-3"><?php echo e($user->phone ?: '-'); ?></div>
                                </div>

                                <div>
                                    <p class="text-xs uppercase tracking-wider text-on-surface-variant font-semibold mb-1">Alamat</p>
                                    <div class="bg-white rounded-xl px-4 py-3"><?php echo e($user->address ?: '-'); ?></div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section class="bg-surface-container rounded-2xl p-6">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <div class="bg-white rounded-xl px-4 py-3"><?php echo e($donations->count()); ?></div>
                                </div>

                                <div>
                                    <p class="text-xs uppercase tracking-wider text-on-surface-variant font-semibold mb-1">Donasi Open</p>
                                    <div class="bg-white rounded-xl px-4 py-3"><?php echo e($donations->where('status', 'open')->count()); ?></div>
                                </div>

                                <div>
                                    <p class="text-xs uppercase tracking-wider text-on-surface-variant font-semibold mb-1">Donasi Diproses</p>
                                    <div class="bg-white rounded-xl px-4 py-3"><?php echo e($donations->where('status', 'in_progress')->count()); ?></div>
                                </div>

                                <div>
                                    <p class="text-xs uppercase tracking-wider text-on-surface-variant font-semibold mb-1">Donasi Selesai</p>
                                    <div class="bg-white rounded-xl px-4 py-3"><?php echo e($donations->where('status', 'completed')->count()); ?></div>
                                </div>
                            </div>
                        </section>
                    </div>
    ...
    <div id="profileModal" class="fixed inset-0 bg-black/40 hidden items-center justify-center z-50 p-4">
        <div class="bg-white w-full max-w-lg rounded-2xl p-6 shadow-xl relative max-h-[90vh] overflow-y-auto">
            ...
            <form action="<?php echo e(route('user.profile.update')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
    ...
    <div id="avatarModal" class="fixed inset-0 bg-black/40 hidden items-center justify-center z-50 p-4">
        <div class="bg-white w-full max-w-lg rounded-2xl p-6 shadow-xl relative max-h-[90vh] overflow-y-auto">
            ...
            <form action="<?php echo e(route('user.photo.update')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                <?php echo csrf_field(); ?>
