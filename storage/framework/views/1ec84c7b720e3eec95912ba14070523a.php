...
<div class="max-w-3xl mx-auto px-6 py-10">
    ...
    <div class="bg-white rounded-3xl shadow border border-[#eae1da] overflow-hidden">
        ...
        <div class="p-8">
            ...
            <!-- FORM -->
            <form action="<?php echo e(route('donation.submit', $donation->id)); ?>"
                  method="POST"
                ...
                <div>
                    ...
                    <input
                        type="text"
                        value="<?php echo e($donation->title); ?>"
                        disabled
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="w-full rounded-2xl border border-[#eae1da]
                               px-4 py-3 text-sm
                               focus:ring-2 focus:ring-[#006c49]"><?php echo e(old('pickup_address', auth()->user()->address ?? '')); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="w-full rounded-2xl border border-[#eae1da]
                               px-4 py-3 text-sm
                               focus:ring-2 focus:ring-[#006c49]"><?php echo e(old('notes')); ?></textarea>
                </div>
...
<?php /**PATH D:\programming files yk\eco-don\resources\views/user/donate-form.blade.php ENDPATH**/ ?>