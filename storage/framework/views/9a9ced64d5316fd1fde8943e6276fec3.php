        ...
        <div class="bg-white rounded-[2rem] shadow-soft overflow-hidden border border-[#eadfd8]">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4">
                ...
                <main class="lg:col-span-3 p-6 md:p-10">
                    ...
                    <form action="<?php echo e(route('organization.donation.store')); ?>" method="POST" class="space-y-8">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea name="description" rows="5"
                                        class="w-full rounded-2xl border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-secondary"
                                        placeholder="Jelaskan tujuan program donasi, siapa penerimanya, dan kenapa bantuan ini dibutuhkan..."><?php echo e(old('description')); ?></textarea>
                                </div>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="quantity" value="<?php echo e(old('quantity')); ?>"
                                        class="w-full rounded-2xl border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-secondary"
                        ...
                        <section>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input type="text" name="contact_person" value="<?php echo e(old('contact_person')); ?>"
                                        class="w-full rounded-2xl border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-secondary"
...
</html><?php /**PATH D:\programming files yk\eco-don\resources\views/organization/createDonation.blade.php ENDPATH**/ ?>